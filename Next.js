...
<nav className="hidden md:flex gap-6 text-sm font-medium">
  ...
  <footer id="contact" className="bg-slate-900 text-slate-300 py-10 text-center">
...
export const metadata = { title: "Fatcom Solutions", description: "Online Earning Platform", };
...
{ "name": "fatcom-solutions", "version": "1.0.0", "private": true, "scripts": { "dev": "next dev", "build": "next build", "start": "next start" }, "dependencies": { "next": "latest", "react": "latest", "react-dom": "latest" }, "devDependencies": { "autoprefixer": "latest", "postcss": "latest", "tailwindcss": "latest" } }
...
// 1. Upload project to GitHub // 2. Login to Vercel // 3. Import GitHub repository // 4. Click Deploy

// ========================================= // PROJECT STRUCTURE // =========================================

// fatcom-solutions/ // ├── app/ // │   ├── globals.css // │   ├── layout.js // │   └── page.js // ├── package.json // ├── tailwind.config.js // ├── postcss.config.js // └── next.config.js
